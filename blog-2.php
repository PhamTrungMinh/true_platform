...
<html>
    <head>
        ...
        <title>Blog - Page 2 - True Platform</title>    
    </head>
    ...
    <body class="blog footer-on-bottom hide-focus-outline">
                    ...
                    <div class="col70">
                        <div class="box-menu">
                            <ul class="primary-menu">
                                ...
                                <li>
                                    <a href="http://localhost/true_platform/true-engineer.html" class="text-blink">True Engineer</a>
                                </li>
                                <li>
                ...
                <div id="primary" class="content-area">
                    <div class="content-container site-container">
                        <main id="main" class="site-main" role="main">
                            <div id="archive-container" class="content-wrap grid-cols 
                            ...
                            <nav class="pagination">
                                ...
                                <div class="nav-links">
                                    <a class="next page-numbers" href="http://localhost/true_platform/blog.php">
                                        <i class=" baseline uil uil-angle-left-b"></i>
                                    </a>
                                    <a class="page-numbers" href="http://localhost/true_platform/blog.php">1</a>
        ...
        <div id="footer">
            ...
            <div class="bottom-footer">
                <div class="copyright">
                    Powered by 
                    <a target="_blank" href="https://base.vn/hiring?utm_source=https://talent.platform.inc">Base E-Hiring.</a>
                </div>
            </div>
        </div>
    </body>
